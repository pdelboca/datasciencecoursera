...
sprintf("Theoretical Mean: %g - Empirical Mean: %g", theoreticalMean, empiricalMean)
```
...
empiricalSD <- sd(x)
sprintf("Theoretical SD: %g - Empirical SD: %g", theoreticalSD, empiricalSD)
```
...
Now I need simulate a thousand times, and for each simulation extract the mean.
